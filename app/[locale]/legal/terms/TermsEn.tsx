...
/**
 * English terms and conditions. See ./TermsEs.tsx for the Spanish text and
 * ./page.tsx for how the locale picks between them.
 *
 * This was previously a Termly HTML export injected with
 * `dangerouslySetInnerHTML`, carrying its own inline `<style>` block that
 * forced Arial and #000 over the design system — so the terms page was the one
 * page on the site that did not look like the site. The words are unchanged
 * except where noted below; only the markup is.
 *
 * Two sections were removed as describing things that do not exist: the mobile
 * application licence (there is no app) and SMS text messaging (we send none).
 * The remaining sections were renumbered 1–27; nothing cross-references a
 * section by number, only by name, so the renumbering is safe.
 */
export default function TermsEn() {
    return (
        <article className="prose prose-stone max-w-none prose-headings:font-serif prose-headings:text-ac-taupe prose-p:text-ac-taupe/80 prose-a:text-ac-espresso hover:prose-a:text-ac-taupe">
            ...
            <p>We are AC Styling (&quot;<strong>Company</strong>,&quot; &quot;<strong>we</strong>,&quot; &quot;<strong>us</strong>,&quot; &quot;<strong>our</strong>&quot;), a company registered in Florida, United States at 1865 S Ocean Dr, Hallandale Beach, FL 33009.</p>
            <p>We operate the website <a href="https://www.theacstyle.com">https://www.theacstyle.com</a> (the &quot;<strong>Site</strong>&quot;), as well as any other related products and services that refer or link to these legal terms (the &quot;<strong>Legal Terms</strong>&quot;) (collectively, the &quot;<strong>Services</strong>&quot;).</p>
            <p>AC Styling provides digital fashion consulting and educational content. Our services include:</p>
            <ul>
                <li><strong>Digital Products:</strong> Access to pre-recorded video Masterclasses, downloadable guides, and course materials (collectively, &quot;The Vault&quot;).</li>
                <li><strong>Consulting Services:</strong> Personalized styling advice, wardrobe reviews (&quot;Detox&quot;), and curation services delivered via digital platforms.</li>
                <li><strong>Disclaimer:</strong> All styling advice is subjective and intended for informational and aesthetic purposes. The Client retains full discretion over all purchasing decisions.</li>
            </ul>
            <p>You can contact us by email at <a href="mailto:fashionstylist.ac@gmail.com">fashionstylist.ac@gmail.com</a> or by mail to 1865 S Ocean Dr, Hallandale Beach, FL 33009, United States.</p>
            <p>These Legal Terms constitute a legally binding agreement made between you, whether personally or on behalf of an entity (&quot;you&quot;), and AC Styling, concerning your access to and use of the Services. You agree that by accessing the Services, you have read, understood, and agreed to be bound by all of these Legal Terms. IF YOU DO NOT AGREE WITH ALL OF THESE LEGAL TERMS, THEN YOU ARE EXPRESSLY PROHIBITED FROM USING THE SERVICES AND YOU MUST DISCONTINUE USE IMMEDIATELY.</p>
            ...
            <p>When you post Contributions, you grant us a license (including use of your name, trademarks, and logos). By posting any Contributions, you grant us an unrestricted, unlimited, irrevocable, perpetual, non-exclusive, transferable, royalty-free, fully-paid, worldwide right, and license to use, copy, reproduce, distribute, sell, resell, publish, broadcast, retitle, store, publicly perform, publicly display, reformat, translate, excerpt, and exploit your Contributions.</p>
            <p>You are responsible for what you post or upload.</p>
            <h3>Copyright infringement</h3>
            <p>We respect the intellectual property rights of others. If you believe that any material available on or through the Services infringes upon any copyright you own or control, please refer to the &quot;COPYRIGHT INFRINGEMENTS&quot; section below.</p>
            ...
            <h2 id="purchases">6. PURCHASES AND PAYMENT</h2>
            ...
            <p>The Services may invite you to chat, contribute to, or participate in blogs, message boards, online forums, and other functionality. Contributions may be viewable by other users of the Services and through third-party websites. When you create or make available any Contributions, you represent and warrant that they do not infringe proprietary rights, you have necessary licenses, and they are not false, inaccurate, or misleading.</p>

            <h2 id="contribution">10. CONTRIBUTION LICENSE</h2>
            <p>By posting your Contributions to any part of the Services, you automatically grant us an unrestricted, unlimited, irrevocable, perpetual, non-exclusive, transferable, royalty-free, fully-paid, worldwide right, and license to host, use, copy, reproduce, disclose, sell, resell, publish, broadcast, retitle, archive, store, cache, publicly perform, publicly display, reformat, translate, transmit, excerpt, and distribute such Contributions.</p>

            <h2 id="thirdparty">11. THIRD-PARTY WEBSITES AND CONTENT</h2>
            <p>The Services may contain links to other websites (&quot;Third-Party Websites&quot;) as well as articles, photographs, text, graphics, pictures, designs, music, sound, video, information, applications, software, and other content or items belonging to or originating from third parties (&quot;Third-Party Content&quot;). We are not responsible for any Third-Party Websites accessed through the Services or any Third-Party Content posted on, available through, or installed from the Services.</p>

            <h2 id="management">12. SERVICES MANAGEMENT</h2>
            <p>We reserve the right, but not the obligation, to: (1) monitor the Services for violations of these Legal Terms; (2) take appropriate legal action against anyone who violates the law or these Legal Terms; (3) refuse, restrict access to, limit the availability of, or disable any of your Contributions; (4) remove from the Services or otherwise disable all files and content that are excessive in size; and (5) otherwise manage the Services in a manner designed to protect our rights and property.</p>

            <h2 id="privacypolicy">13. PRIVACY POLICY</h2>
            <p>We care about data privacy and security. Please review our <Link href="/legal/privacy">Privacy Policy</Link>. By using the Services, you agree to be bound by our Privacy Policy, which is incorporated into these Legal Terms. Please be advised the Services are hosted in the United States.</p>

            <h2 id="copyright">14. COPYRIGHT INFRINGEMENTS</h2>
