...
export default function OfferForm({ slug, initialTitle, initialDescription, onClose }: OfferFormProps) {
    ...
    useEffect(() => {
        ...
        load();
    }, [slug, initialTitle, initialDescription]);
                ...
                <div className="flex gap-4 items-end mb-4 border-b border-ac-taupe/5 pb-4">
                    <div className="flex-1">
                        ...
                        <input
                            ...
                            id="gen-price-input-offer"
                        />
                    </div>
                    <button
                        type="button"
                        onClick={async () => {
                            const priceInput = document.getElementById('gen-price-input-offer') as HTMLInputElement;
