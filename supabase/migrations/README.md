...
| `20260710_02_restrict_partner_brands_read.sql` | #6 partner_brands PII leak | Public reads move to the `public_partner_brands` view. Confirm the boutique read paths use the view (or the display columns) before applying. |
