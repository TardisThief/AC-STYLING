> **Archived 2026-09-21.** This is the roadmap as it stood at the end of the
> pre-content engineering push, kept whole because the *reasons* recorded here
> are the valuable part — particularly why Ops polish, the north-star features,
> F12 and F16 were parked, and the "considered and rejected" section. It had
> grown to 749 lines and had started getting in the way of the work it was
> meant to organise.
>
> The live roadmap is `ROADMAP.md`. Nothing here is a current commitment;
> read it for history and rationale, not for what to do next.
